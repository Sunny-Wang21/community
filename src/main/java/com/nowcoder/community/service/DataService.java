...
public class DataService {
    ...
    public void recordUV(String ip){
        ...
        redisTemplate.opsForHyperLogLog().add(redisKey, ip);//ip追加到现有字符串的末尾
    }
    ...
    public long calculateUV(Date startDate, Date endDate){
        ...
        // 合并这些数据
        String redisKey = RedisKeyUtil.getUVKey(sf.format(startDate), sf.format(endDate));
    ...
    public long calculateDAU(Date startDate, Date endDate){
        ...
        return (long) redisTemplate.execute(new RedisCallback() {
            ...
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                String redisKey = RedisKeyUtil.getDAUKey(sf.format(startDate), sf.format(endDate));
